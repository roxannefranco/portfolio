...
projects.forEach(function (project) {
  ...
  <div class="single-project">
            <div class="project-text">
                ...
                <div class="buttons">
                    <a class="cta" href="${project.link}" target="_blank">live website</a>
                    <a class="cta icon" href="${project.github}" target="_blank"><svg width="19" height="19" viewBox="0 0 19 19" fill="none"
